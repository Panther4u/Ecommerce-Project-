...
import './widget.scss'; // Your SCSS file
import KeyboardArrowUpIcon from '@mui/icons-material/KeyboardArrowUp';
import PersonOutlinedIcon from '@mui/icons-material/PersonOutlined';
import AccountBalanceWalletOutlinedIcon from '@mui/icons-material/AccountBalanceWalletOutlined';
import ShoppingCartOutlinedIcon from '@mui/icons-material/ShoppingCartOutlined';
...
const Widget = ({ type }) => {
  ...
  const fetchData = async () => {
    try {
      ...
      switch (type) {
        case 'user':
          response = await axios.get('http://localhost:8000/api/user/username'); // Replace 'username' with actual username
          setData({
            title: 'USERS',
            isMoney: false,
            link: 'See all users',
          ...
          break;
        case 'order':
          response = await axios.get('http://localhost:8000/api/orders');
          setData({
            title: 'ORDERS',
            isMoney: false,
            link: 'View all orders',
      ...
      // Example of setting amount and diff
      setAmount(100);
      setDiff(20);
