...
// import { useSelector, useDispatch } from 'react-redux';
// import { Link, NavLink } from 'react-router-dom';
// import { mobileNavData } from 'src/Data/staticData'; // Replace with your static data path
// import SvgIcon from '../MiniComponents/SvgIcon'; // Adjust path as needed
// import s from './MobileNav.module.scss'; // Adjust path as needed
// import axios from 'axios';
// import { signOut } from '../../../Features/userSlice'; // Adjust path based on your project structure
// import Avatar from "src/Assets/Images/Avatar.jpg"; // Adjust path based on your project structure

// const MobileNav = () => {
//   const dispatch = useDispatch();
//   const { isMobileMenuActive } = useSelector((state) => state.global); // Assuming global state contains isMobileMenuActive
//   const { loginInfo } = useSelector((state) => state.user);
//   const { username, isSignIn, role } = loginInfo || {};
//   const [profileImage, setProfileImage] = useState(null);
...
//       <nav className={s.navLinks}>
//         <ul>
//           {filteredNavData.map(({ name, link, icon, requireSignIn }, index) => {
//             const shouldShow = requireSignIn ? isSignIn : true;
//             if (!shouldShow) return null;
...
//         </button>
//       ) : (
//         <Link to="/signin" className={s.signOutButton}>
//           <SvgIcon name="boxArrowRight" />
//           <span>Sign In</span>
//         </Link>
//       )}
